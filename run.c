...
void display_run_map(PLAYER* player, int fin_position){
    //for player run in the map
    //fin_position is the player run to finnally
...
{
    //end_round is the key for end this round or not
    //this function is to imitate player run step by step except last one
...
{
    //when player arrive tool house use this function
